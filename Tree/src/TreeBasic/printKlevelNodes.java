...
public class printKlevelNodes {
	...
	public static void printKchildren(Tree<Integer> root, int k) {
		if (k==0) {
			System.out.print("kth Level Nodes "+ root.data+", ");
			return;
		}
		for (int i=0; i< root.children.size();i++) {
			printKchildren(root.children.get(i), k-1);
		}
	}
